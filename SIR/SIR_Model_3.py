...
def Model_3(G, H, a, b, beta, mu, initial_infecteds, initial_recovereds, tmin = 0, tmax = float('Inf')):
    r'''    
...
for beta in np.arange(beta_min, beta_max, beta_gap):
    ...
    for i in range(iteration):
        ...
        f = Model_3(G, H, a, b, beta, mu, initial_infecteds, initial_recovereds, tmin = 0, tmax = float('Inf'))
        fraction = f / n
...
np.savetxt('M3_q0.1_f_1k5.txt', fraction_of_recovered)
