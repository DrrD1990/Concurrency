...
def Model_1prime(G, H, b, beta, mu, C1, C2, lamda1, lamda2, D1, D2, initial_infecteds, initial_recovereds, tmin = 0, tmax = float('Inf')):
...
for beta in np.arange(beta_min, beta_max, beta_gap):
    ...
    for i in range(iteration):
        ...
        f = Model_1prime(G, H, b, beta, mu, C1, C2, lamda1, lamda2, D1, D2, initial_infecteds, initial_recovereds, tmin = 0, tmax = float('Inf'))
        fraction = f / n
        fraction_list.append(fraction)
    fraction_mean = np.mean(fraction_list)
    fraction_of_recovered.append(fraction_mean)

np.savetxt('M1p_q0.1_f_1k1.txt', fraction_of_recovered)
